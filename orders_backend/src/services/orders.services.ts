...
export class OrderService implements Orders {
    ...
    async CancelOrder(user_id: string, order_id: string): Promise<boolean> {
    ...
    async getOrderStatus(user_id: string, order_id: string): Promise<any> {
    ...
    async updateOrder(user_id: string, order_id: string, status: string): Promise<boolean> {
    ...
    async getUserOrders(user_id: string): Promise<any[]> {
